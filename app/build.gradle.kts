...
android {
    ...
    productFlavors {
        ...
        create("dgwk2026") {
            dimension = defaultDimension
            applicationId = "ch.digitale_gesellschaft.winterkongress.schedule"
            versionName = "${defaultConfig.versionName}-DGWK-Edition"
            buildConfigField("String", "GOOGLE_PLAY_URL", """"https://play.google.com/store/apps/details?id=ch.digitale_gesellschaft.winterkongress.schedule"""")
            buildConfigField("String", "F_DROID_URL", """"https://f-droid.org/packages/ch.digitale_gesellschaft.winterkongress.schedule"""")
            ...
            buildConfigField("boolean", "SHOW_APP_DISCLAIMER", "true")
            buildConfigField("boolean", "ENGAGE_C3NAV_APP_INSTALLATION", "false")
            buildConfigField("String", "SOCIAL_MEDIA_HASHTAGS_HANDLES", """"#winterkongress"""")
            buildConfigField("String", "TRACE_DROID_EMAIL_ADDRESS", """"hoermi+dgwk2026-crash-reports@posteo.ch"""")
            buildConfigField("String", "SCHEDULE_FEEDBACK_URL", """""""")
        }
